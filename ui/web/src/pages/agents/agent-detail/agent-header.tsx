...
import { ArrowLeft, Bot, Eye, Heart, Sparkles, Star, Trash2 } from "lucide-react";
...
export function AgentHeader({ agent, heartbeat, onBack, onDelete, onHeartbeat, onSystemPrompt }: AgentHeaderProps) {
