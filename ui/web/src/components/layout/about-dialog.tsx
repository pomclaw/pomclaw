      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2.5">
            <img src="/pomclaw-icon.svg" alt="PomClaw" className="h-7 w-7" />
            {t("about.title")}
        ...
        <div className="grid gap-3 py-2">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm">
            {[
              { label: t("about.sourceCode"), href: "https://github.com/nextlevelbuilder/pomclaw" },
              { label: t("about.license"), href: "https://creativecommons.org/licenses/by-nc/4.0/" },
              { label: t("about.documentation"), href: "https://docs.pomclaw.sh" },
              { label: t("about.reportBug"), href: "https://github.com/nextlevelbuilder/pomclaw/issues" },
            ].map(({ label, href }) => (
              <a
                key={label}
                href={href}
