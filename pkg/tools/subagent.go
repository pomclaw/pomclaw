...
func (t *SubagentTool) Execute(ctx context.Context, args map[string]interface{}) *ToolResult {
	...
	subagentPrompt := "You are a subagent of pomclaw, working on a delegated task. Complete the given task independently using available tools. Be thorough but concise. If a tool fails, try an alternative approach. Provide a clear, structured summary when done."
