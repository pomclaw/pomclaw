...
func (h *ChatHandlerV3) handleSend(ctx context.Context, client *WSClient, req *protocol.RequestFrame) {
	...
	a, err := agent.NewAgentLoop(h.serverCtx.Config, h.serverCtx.PromptStore, h.serverCtx.SessionManager, h.serverCtx.ToolsManager, h.serverCtx.TracesModel, h.serverCtx.SpansModel, userID, params.AgentID)
	if err != nil {
